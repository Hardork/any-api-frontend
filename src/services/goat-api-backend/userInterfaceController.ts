...
/** getFreeInvokeNum POST /api/userInterfaceInfo/freeInvoke */
export async function getFreeInvokeNumUsingPOST(
  body: API.UserInterfaceInfoFreeRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseLong_>('/api/userInterfaceInfo/freeInvoke', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
